...
;(base) chat@chat-HP-Laptop-15-da0xxx:~/Desktop/MPL 21418/Assignment6$ nasm -f elf64 sys.asm
;(base) chat@chat-HP-Laptop-15-da0xxx:~/Desktop/MPL 21418/Assignment6$ ld -o sys sys.o
;ld: warning: cannot find entry symbol _start; defaulting to 00000000004000b0
;(base) chat@chat-HP-Laptop-15-da0xxx:~/Desktop/MPL 21418/Assignment6$ ./sys
;
; GDTR 
;00135000007F
; IDTR 
...
;(base) chat@chat-HP-Laptop-15-da0xxx:~/Desktop/MPL 21418/Assignment6$ 
